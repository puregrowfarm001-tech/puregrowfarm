...
function computeFinancialLedgerStatements() {
  ...
  // 5) Partner-wise Expense Totals (Expenses only)
  ...
  // 6) Partner & Farm Total = 4 + 5 Total (Buy + Expense)
  ...
  // 9) Damage Totals & Partner Adjustments
  ...
  // 7) Farm Available Balance: 3 - 6 (6 me sirf farm ka total minus hoga)
